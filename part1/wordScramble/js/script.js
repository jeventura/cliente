...
function generateGrid() {
  ...
  // 🧩 Colocamos manualmente las nuevas palabras

  // WERK vertical (de (0,0) a (3,0))
  placeWordAt("WERK", 0, 0, 1, 0);

  // GLAMAZON horizontal (fila 2, columnas 1 a 8)
  placeWordAt("GLAMAZON", 2, 1, 0, 1);

  // PITCREW diagonal (de (3,3) a (9,9))
  placeWordAt("PITCREW", 3, 3, 1, 1);

  // SLAY vertical (columna 9, de (0,9) a (3,9))
  placeWordAt("SLAY", 0, 9, 1, 0);
